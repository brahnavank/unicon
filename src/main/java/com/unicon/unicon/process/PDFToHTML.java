package com.unicon.unicon.process;
...
public class PDFToHTML {
	/**
	 * Third party convert library REFER :
	 * https://github.com/radkovo/Pdf2Dom/blob/master/src/main/java/org/fit/pdfdom/PDFToHTML.java
	 * 
	 * @param args
	 */
	...
	public static void convert(String[] args) {
		if (args.length < 1) {
			...
			System.out.println(
					"Usage: PDFToHTML .pdf .html [<options>] -fm=SAVE_TO_DIR -fdir=dir/my-font-dir -im=SAVE_TO_DIR -idir=dir/my-font-dir");
		}
